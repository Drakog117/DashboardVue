...
export function cargarGraficoIngresosPuntoEquilibrio() {
    // Obtener datos de PHP
    fetch('http://localhost/phpDash/kpslist.php')
...
export function cargarClientesPorMes() {
    // Obtener datos de PHP
    fetch('http://localhost/phpDash/kpslist.php')
      .then(response => response.json())
      .then(data => {
...
export function inicializarGraficoVentasPorServicio() {
  // Obtener datos de PHP
  fetch('http://localhost/phpDash/kpslist.php')
    .then(response => response.json())
    .then(data => {
...
export function cambiarTipoGrafica() {
